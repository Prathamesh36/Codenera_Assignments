/*7. Implement a Java method to remove duplicates from an ArrayList without using additional data structures.*/
package Test11;

import java.util.ArrayList;

public class RemoveDuplicateFromArrayListWithoutAddiDS {
